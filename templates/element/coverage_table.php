...
<tr><th><?php echo __d('translate', 'Locale'); ?></th><th><?php echo __d('translate', 'Coverage'); ?></th><th><?php echo __d('translate', 'Translated'); ?></th></tr>
<?php foreach ($languages as $language) {
	...
	$stats = $localeStats[$language->locale] ?? ['translated' => 0, 'total' => 0];
	?>
<tr>
